...
const GrandesEmpresas: React.FC = (props) => {
        ...
        <>
            ...
            <div className="body">
                <div className="product-panel">
                    <form >
                        <h1 className="icon-product"><FiCodesandbox></FiCodesandbox></h1>
                        <h2 className="product-title">Grandes Empresas</h2>
                        <h5 className="pricing-product" >R$ 250,00 por mês</h5>
